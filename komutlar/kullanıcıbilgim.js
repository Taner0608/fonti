...
exports.run = async (client, message, args) => {
  ...
  const durm = (Durum == "online" ? (client.emojis.get('670247512099258368') + "Çevrimiçi") : (Durum == "offline" ? (client.emojis.get('670247511499341824') + "Çevrimdışı") : (Durum == "idle" ? (client.emojis.get('') + "Boşta") : (Durum == "dnd" ? (client.emojis.get('') + "Rahatsız Etmeyin") : ("Bilinmiyor/bulunamadı.")))))
const botemoji = client.emojis.get('')
            var tarih = ''
